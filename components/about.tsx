  ...
  return (
    ...
    >
      ...
      passion for problem-solving 
        <span className="font-medium"> Proficient in both front-end and back-end development</span>, I decided to pursue my
        passion for programming. I enrolled in a coding at Wethinkcode and learned{" "}
